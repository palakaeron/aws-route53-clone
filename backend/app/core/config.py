...
SESSION_TTL_HOURS = int(os.getenv("SESSION_TTL_HOURS", os.getenv("SESSION_EXPIRY", "8")))
SESSION_COOKIE_SECURE = os.getenv("SESSION_COOKIE_SECURE", os.getenv("COOKIE_SECURE", "false")).lower() == "true"
FRONTEND_ORIGINS = [
    origin.strip()
